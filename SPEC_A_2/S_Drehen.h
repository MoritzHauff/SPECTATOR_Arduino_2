...
const int S_Drehen_MinSpeed = 80;  // Die niedrigste Geschwindigkeit bei denen die Motoren den SPECTATOR noch bewegen.
const int S_Drehen_MaxSpeed = 180;  // Die höchste Motorgeschwindigkeit beim Drehen.

const int S_Drehen_MotorSteigung = 300;  // Mit welcher Steigung die Motorgeschwindigkeit mit größerem MotorAbstand zunimmt.
